...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mosartwmpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13023&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mosartwmpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mosartwmpy` can be installed with:

```
conda install mosartwmpy
```

It is possible to list all of the versions of `mosartwmpy` available on your platform with:
